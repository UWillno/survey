  ...
  <div>
    <el-form :inline="true" :model="selectForm" class="demo-form-inline">
      <el-form-item label="编号">
        <el-input clearable v-model="selectForm.studentNo" placeholder="请输入学号"></el-input>
      </el-form-item>
      <el-form-item label="姓名">
        <el-input clearable v-model="selectForm.studentName" placeholder="请输入学生姓名"></el-input>
      </el-form-item>
      <el-form-item label="状态">
        <el-select clearable v-model="selectForm.status" placeholder="请选择学生状态">
    ...
    <el-table :data="teacherList" stripe style="width: auto">
      ...
      <el-table-column prop="status" type="状态" label="状态">
        <template slot-scope="scope">
          ...
          <el-tag v-if="scope.row.status===3" type="success">休学</el-tag>
          <el-tag v-if="scope.row.status===4" type="success">毕业</el-tag>
        </template>
      </el-table-column>
